    ...
    for file_path in filepaths:
        try:
            if not file_path.is_file():
                logging.info(f"Not a regular file or does not exist: '{file_path}'")
                continue
            ...
            logging.info(f"Permission denied to access file: '{file_path}'")
        except Exception as e:
            logging.info(f"An unexpected error occurred with file '{file_path}': {e}")
